...
class NTSCTextureFilter {
    ...
    private let trackingNoiseFilter: TrackingNoiseTextureFilter
    ...
    init(effect: NTSCEffect, device: MTLDevice, ciContext: CIContext) throws {
        ...
        self.trackingNoiseFilter = TrackingNoiseTextureFilter(device: device, ciContext: ciContext, pipelineCache: pipelineCache)
