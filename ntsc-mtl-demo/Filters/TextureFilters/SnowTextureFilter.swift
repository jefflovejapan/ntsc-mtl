...
//        try transform(uniform: uniformRandomTexture, toGeometric: geoRandomTexture, commandBuffer: commandBuffer)
        try applySnow(inputTexture: inputTexture, yiqGeometricTexture: /*geoRandomTexture*/uniformRandomTexture, outputTexture: outputTexture, commandBuffer: commandBuffer)
    }
